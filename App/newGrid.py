...
for fakeY in range(1,10):
    ...
    for fakeX in range(1,10):
        ...
        # label = tk.Label(master=largeFrameList[largeframeY][largeframeX],text="{},{}".format(fakeX,fakeY) ,width=4,height=2)
        # label.grid(row=gridY,column=gridX)
        
        tXentrys.append(entry)
        # tXentrys.append(label)
